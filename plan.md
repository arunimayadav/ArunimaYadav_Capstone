...
I'm aiming for **Claude-driven implementation, human-directed**: I write 
the problem statement and review/approve every plan before execution, 
but Claude does the actual coding inside Claude Code's plan → execute 
loop. I'm choosing this level because the value of this course is in 
learning to scope, direct, and evaluate an agent — not in typing every 
line of Python myself — but I still want full understanding and 
approval of every architectural decision before it's built.
